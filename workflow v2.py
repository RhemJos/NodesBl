...
# =================================================================================================
# NODE FOR DISPLACE MODIFIER **********************************************************************
# NODE: ===========================================================================================
class NodeDisplace(bpy.types.Node):
    ...
    def obtener_displace_mod(self, obj):
        ...
        # # Configurar textura si no existe
        # if not new_mod.texture:
        ...
        #     new_mod.texture = bpy.data.textures[tex_name]
